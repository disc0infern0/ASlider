...
//  ASlider
//
//  Created by Andrew on 11/4/24.
//


/// Below is an option for future consideration - draw a bar with configurable end shapes;
/// - useful primarily to fit snugly alongside different symbols - circle based or rectangular
